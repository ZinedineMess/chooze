...
export const GET_CHOOZE_URL = CHOOZE_BASE_PATH + "/choozes/get-chooze?id=";
export const EDIT_CHOOZE_URL = CHOOZE_BASE_PATH + "/choozes/edit-chooze?id=";
export const DELETE_CHOOZES_URL = CHOOZE_BASE_PATH + "/choozes/delete-chooze?id=";
